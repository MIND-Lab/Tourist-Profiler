...
class RecommenderNetwork(object):
    ...
    def predict_with_attentions(self, test_u, test_num, test_i, test_l):
        feed_dict = {self.user_input: test_u, self.num_idx: test_num, self.item_input: test_i,
                     self.labels: test_l}
    ...
    def get_item_embedding(self):
        item_embedding_user = self.sess.run(self.embedding_Q_)
        item_embedding_item = self.sess.run(self.embedding_Q)
        return np.array(item_embedding_user), np.array(item_embedding_item)
